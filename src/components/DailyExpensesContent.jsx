        ...
        <div className="bg-white">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-10">
                ...
                <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto">
                    <div className="flex-1 lg:flex-none bg-white px-6 py-3.5 rounded-2xl border border-slate-100 shadow-sm min-w-[200px]">
                            ...
                            {filteredExpenses.length > 0 ? (
                                filteredExpenses.map((exp) => (
                                    <tr key={exp.id} className="hover:bg-slate-50/80 transition-all group">
                                        <td className="px-10 py-7">
                                            <div className="flex items-center gap-3">
                                                <div className="p-2 rounded-xl bg-white border border-slate-100 text-slate-400 group-hover:bg-[#00BCE4]/10 group-hover:text-[#00BCE4] transition-colors">
                                                    <Calendar size={14} />
                                                </div>
                                                <div>
                                        ...
                                        <td className="px-10 py-7">
                                            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white rounded-lg text-[9px] font-black text-slate-500 uppercase tracking-widest border border-slate-200/50 group-hover:bg-[#00BCE4]/5 transition-colors">
                                ...
                                <tr>
                                    <td colSpan="6" className="py-32 text-center">
                                        <div className="inline-flex p-8 bg-white border-2 border-dashed border-slate-200 rounded-[3rem] mb-6 text-slate-200">
                ...
                <div className="space-y-6 py-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div className="space-y-2 group">
                            ...
                            <input name="name" value={formData.name} onChange={handleChange} placeholder="Nima uchun xarajat qilindi?" className="w-full p-4.5 bg-white border border-slate-200 rounded-2xl outline-none focus:border-[#00BCE4] font-bold text-slate-800 transition-all shadow-inner" />
                        </div>
                        <div className="space-y-2 group">
                            ...
                            <input name="price" value={formData.price} onChange={handleChange} placeholder="0.00" className="w-full p-4.5 bg-white border border-slate-200 rounded-2xl outline-none focus:border-[#00BCE4] font-black text-[#00BCE4] transition-all shadow-inner" />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2 group">
                        ...
                        <select name="category" value={formData.category} onChange={handleChange} className="w-full p-4.5 bg-white border border-slate-200 rounded-2xl outline-none focus:border-[#00BCE4] font-bold text-slate-800 transition-all appearance-none cursor-pointer shadow-inner">
                    ...
                    <div className="space-y-2 group">
                        ...
                        <textarea name="description" value={formData.description} onChange={handleChange} placeholder="Xarajat bo'yicha izoh (ixtiyoriy)..." className="w-full p-5 bg-white border border-slate-200 rounded-3xl outline-none focus:border-[#00BCE4] font-bold text-slate-800 min-h-[100px] transition-all shadow-inner" />
                    </div>
