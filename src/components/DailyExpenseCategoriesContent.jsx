...
const AddEditCategoryModal = ({ isOpen, onClose, editingCategory }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-black/20 backdrop-blur-sm flex justify-end transition-all">
            <div className="bg-white w-full max-w-md h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
                ...
                <div className="flex justify-between items-center p-8 border-b border-gray-100">
                    ...
                    <button onClick={onClose} className="p-2 hover:bg-gray-50 rounded-xl text-slate-400 transition-colors">
                        <X className="w-6 h-6" />
                    </button>
                </div>
                ...
                <div className="p-8 space-y-8 flex-1">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full p-5 bg-white border border-gray-200 rounded-[1.5rem] outline-none focus:border-[#00BCE4] font-bold text-slate-800 transition-all"
                        />
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex bg-gray-50 border border-gray-100 rounded-2xl p-1.5">
                            <button
                                ...
                                className={`flex-1 py-3 text-xs font-black uppercase tracking-tighter rounded-xl transition-all ${status === 'Faol' ? 'bg-[#00BCE4] text-white shadow-md' : 'text-slate-400 hover:text-slate-600'}`}
                            >
                                {t('active')}
                            </button>
                            <button
                ...
                <div className="p-8 border-t border-gray-100">
                    <button
                        onClick={handleSave}
                        className="w-full py-5 bg-[#00BCE4] text-white font-black rounded-[2rem] shadow-lg shadow-blue-500/10 hover:bg-[#00BCE4] transition-all uppercase tracking-[0.2em] text-xs"
                    >
                ...
                <div className='flex items-center gap-3 w-full md:w-auto'>
                    <div className="relative flex-1 md:w-72 group">
                        ...
                        <input
                            ...
                            className="w-full pl-11 pr-4 py-4 bg-white text-[#00BCE4] border border-gray-200 rounded-2xl outline-none focus:ring-4 focus:ring-blue-500/5 transition-all font-bold text-sm"
                        />
                    </div>

                    <button
                        onClick={() => handleOpenModal(null)}
                        className='p-4 bg-[#00BCE4] text-white rounded-2xl shadow-lg shadow-blue-500/10 hover:bg-[#00BCE4] transition-all active:scale-95'
                    >
                            ...
                            {filteredCategories.length > 0 ? (
                                    ...
                                    <tr key={cat.id} className='hover:bg-gray-50 transition-all group'>
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-3">
                                                <div className="w-8 h-8 bg-gray-50 rounded-lg flex items-center justify-center text-[#00BCE4]">
                                                    <FolderTree size={14} />
                                                </div>
                                ...
                                <tr>
                                    <td colSpan="4" className="py-32 text-center text-slate-300">
                                        <FolderTree size={48} className="mx-auto mb-4 opacity-10" />
