...
const AddCategoryModal = ({ isOpen, onClose, category }) => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log("Kategoriya saqlandi:", { name, status });
        onClose();
    };
    ...
    // Rasmdagi Saydbar (Modal) dizayni: image_fe7a5a.png
    return (
                ...
                >
                    <div className="h-full flex flex-col">
                        ...
                        <form onSubmit={handleSubmit} id="modal-form" className="p-6 space-y-6 grow overflow-y-auto">
                            ...
                            {/* Nomi maydoni */}
                            <div>
                                <label htmlFor="categoryName" className="block text-sm font-medium text-gray-700">Nomi</label>
                                <input
                                    type="text"
                                    id="categoryName"
                                    value={name}
